...
## summarize results of run_dgp1.R

# load saved results
experiment_result <- readRDS("script/result/dgp1_2sample_sumstat.rds")
...
ggsave(paste0("script/result/dgp1_2sample.pdf"), 
       plot = p1, width = 5, height = 3.5)

ggsave(paste0("script/result/dgp1_2sample_estimates.pdf"), 
...
data.table::fwrite(x = df_out, 
                   paste0("script/result/dgp1_2sample.csv"))
...
ggsave(paste0("script/result/dgp1_2sample_combined.pdf"), 
